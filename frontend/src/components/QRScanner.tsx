    ...
    <div className="space-y-6">
      ...
      {step === 'scan' && scanning && (
        <div className="space-y-4">
          <div className="bg-gray-900 rounded-xl overflow-hidden relative">
            ...
            <button
              onClick={stopCamera}
              className="absolute top-4 right-4 bg-primary/80 hover:bg-secondary text-white p-2 rounded-lg transition-colors z-10"
            >
              <X className="w-6 h-6" />
            </button>

            {/* Scanning indicator */}
            <div className="absolute top-4 left-4 bg-vintage-grape-600/80 px-3 py-1 rounded-full flex items-center gap-2 z-10">
              <div className="w-2 h-2 bg-white rounded-full animate-pulse" />
              <span className="text-white text-sm font-medium">Scanning...</span>
            </div>

            {/* Instructions */}
            <div className="absolute bottom-4 left-4 right-4 bg-primary/90 rounded-lg p-4 z-10 transition-colors">
              <p className="text-white text-center font-semibold font-serif">
        ...
        <div className="space-y-4">
          <div className="bg-green-900/20 border border-green-700/50 rounded-lg p-6">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h3 className="text-green-200 font-semibold mb-2 font-serif">QR Code Parsed Successfully</h3>
                <p className="text-green-300 text-sm mb-4">
                  Your Aadhaar signature has been verified. Identity commitment generated.
                </p>
                <div className="bg-primary rounded p-3 mb-4 border border-border-custom">
                  <p className="text-xs text-text-muted mb-1">Identity Commitment:</p>
                  <p className="text-text-primary font-mono text-sm break-all">{commitment.slice(0, 64)}...</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-3">
            <button
              ...
              disabled={loading}
              className="flex-1 bg-vintage-grape-600 hover:bg-vintage-grape-700 disabled:bg-tertiary disabled:text-text-muted text-white px-6 py-3 rounded-lg font-semibold transition-colors flex items-center justify-center gap-2 font-serif"
            >
              {loading ? (
                <>
            ...
            <button
              onClick={resetFlow}
              className="px-6 py-3 border border-border-custom hover:border-text-secondary text-text-secondary rounded-lg font-semibold transition-colors font-serif"
            >
              Cancel
            </button>
          </div>
      ...
      {step === 'registered' && (
        <div className="bg-green-900/20 border border-green-700/50 rounded-lg p-6 text-center">
          ...
          <h3 className="text-2xl font-bold text-text-primary mb-2 font-serif">Identity Registered!</h3>
          <p className="text-green-200 mb-4">
            Your identity commitment has been registered on Solana.
          </p>

          {generatingProofs && (
            <div className="bg-vintage-grape-900/30 border border-vintage-grape-600 rounded-lg p-4 mb-4">
              <Loader className="w-8 h-8 text-vintage-grape-400 mx-auto mb-2 animate-spin" />
              <p className="text-vintage-grape-200 font-semibold font-serif">Generating ZK Proofs...</p>
              <p className="text-vintage-grape-300 text-sm mt-1">
          ...
          <button
            ...
            className="bg-vintage-grape-600 hover:bg-vintage-grape-700 disabled:bg-tertiary disabled:text-text-muted text-white px-8 py-3 rounded-lg font-semibold transition-colors font-serif"
          >
